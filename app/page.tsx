...
import { Loader2, MailCheckIcon, Eye, EyeOff } from "lucide-react"
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4 bg-gradient-to-br from-green-500/10 via-background to-green-500/5 dark:from-green-500/10 dark:via-background dark:to-green-500/5">
      <div className="w-full max-w-sm flex flex-col items-center gap-6">
        <Card className="w-full shadow-lg border-primary/10" size="sm">
          <CardHeader className="text-center space-y-0.5 pb-0">
