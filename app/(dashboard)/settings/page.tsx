                      ...
                      <Table>
                        <TableHeader className="bg-muted/50">
                          <TableRow>
                            ...
                            <TableHead className="border-r">Nama Promo</TableHead>
                            <TableHead className="border-r">Keterangan</TableHead>
                          ...
                          {isLoading ? (
                            Array.from({ length: filteredPromos.length > 0 ? Math.min(filteredPromos.length, 10) : 5 }).map((_, i) => (
                              <TableRow key={i}>
                                ...
                                <TableCell className="border-r"><Skeleton className="w-12 h-[60px] rounded-md mx-auto" /></TableCell>
                            ...
                            filteredPromos.slice((currentPage - 1) * 10, currentPage * 10).map((promo) => (
                              <TableRow key={promo.id}>
                                ...
                                <TableCell className="border-r p-2 cursor-pointer hover:bg-accent/50" onClick={() => handleEditClick(promo)}>
                                  <img
                                    src={promo.src}
                                    alt={promo.title}
                                ...
                                <TableCell className="font-medium border-r cursor-pointer hover:bg-accent/50 transition-colors" onClick={() => handleEditClick(promo)}>{promo.title}</TableCell>
                                <TableCell className="border-r cursor-pointer hover:bg-accent/50 transition-colors" onClick={() => handleEditClick(promo)}>{promo.promo}</TableCell>
                          ...
                          {isLoading ? (
                            ...
                            filteredPilihans.slice((currentPage - 1) * 10, currentPage * 10).map((pilihan) => (
                              <TableRow key={pilihan.id}>
                                ...
                                <TableCell className="border-r p-2 cursor-pointer hover:bg-accent/50" onClick={() => handleEditClickPilihan(pilihan)}>
                                  <img
                                    src={pilihan.src}
                                    alt={pilihan.title}
                                    className="w-12 h-[60px] rounded-md object-cover border mx-auto"
                                ...
                                <TableCell className="font-medium border-r cursor-pointer hover:bg-accent/50 transition-colors" onClick={() => handleEditClickPilihan(pilihan)}>{pilihan.title}</TableCell>
                                <TableCell className="border-r cursor-pointer hover:bg-accent/50 transition-colors" onClick={() => handleEditClickPilihan(pilihan)}>{pilihan.price}</TableCell>
                                <TableCell className="border-r text-center">
                                  <Switch
                                    checked={pilihan.is_active}
                                    onCheckedChange={async (checked) => {
                    ...
                    <Dialog open={isBannerDialogOpen} onOpenChange={setIsBannerDialogOpen}>
                      <DialogContent className="w-[95vw] sm:max-w-xl md:max-w-3xl lg:max-w-4xl p-6 md:p-8 max-h-[90vh] overflow-y-auto rounded-2xl">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-6">
                          ...
                          {/* Kolom Kanan: Preview */}
                          <div className="flex flex-col items-center md:items-end justify-center w-full order-1 md:order-2 mb-2 md:mb-0">
                            <div className="w-full relative rounded-md border border-input overflow-hidden bg-muted/30 aspect-[2/1] shadow-sm">
                              {newBanner.src ? (
                      ...
                      <Table>
                        <TableHeader className="bg-muted/50">
                          <TableRow>
                            ...
                            <TableHead className="w-[160px] border-r text-center">Foto Banner</TableHead>
                            <TableHead className="border-r">Nama / Judul Banner</TableHead>
                            <TableHead className="border-r text-center w-[100px]">Status</TableHead>
                          </TableRow>
                        </TableHeader>
                        <TableBody>
                          {isLoading ? (
                            Array.from({ length: filteredBanners.length > 0 ? Math.min(filteredBanners.length, 10) : 5 }).map((_, i) => (
                              <TableRow key={i}>
                                <TableCell className="border-r"><Skeleton className="h-6 w-8 mx-auto" /></TableCell>
                                <TableCell className="border-r"><Skeleton className="w-28 h-14 rounded-md mx-auto" /></TableCell>
                            ...
                            filteredBanners.slice((currentPage - 1) * 10, currentPage * 10).map((banner) => (
                              <TableRow key={banner.id}>
                                ...
                                <TableCell className="border-r p-2 cursor-pointer hover:bg-accent/50" onClick={() => handleEditClickBanner(banner)}>
                                  <img
                                    src={banner.src}
                                    alt={banner.title}
                                    className="w-28 h-14 rounded-md object-cover border mx-auto"
                                  />
                                </TableCell>
                                <TableCell className="font-medium border-r cursor-pointer hover:bg-accent/50 transition-colors" onClick={() => handleEditClickBanner(banner)}>
                                  {banner.title}
                                </TableCell>
                                <TableCell className="border-r text-center">
                                  <Switch
